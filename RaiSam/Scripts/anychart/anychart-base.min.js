...
$.g.Hd=function(){var a=sl(this);a&&$.n(this.ra)&&!this.ra&&this.o(ll,!1);this.ra=a;if(this.$f()||this.vd||!this.f||this.f.Ge())return this;if(!this.enabled()&&(this.G||a))return this.J(ll)&&($.Ve(this.wd),this.I(ll)),this;if(!TB){var b="",c=$.Le("STYLE");c.type="text/css";b+='.anychart-credits{display:none;position:absolute;overflow:hidden;right:9px;bottom:6px;height:10px;}.anychart-credits a {text-decoration:none;}.anychart-credits-logo{border:none;margin-right:2px;height:10px;width:10px;display:inline-block;vertical-align:top;}.anychart-credits-text{font-size:10px;line-height:9px;display:inline-block;vertical-align:top;text-decoration:none;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;color:#929292;height:10px;}';
